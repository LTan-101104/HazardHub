        ...
        <div className="space-y-6 text-center">
          ...
          <div className="p-4 bg-[#2a2a2a] rounded-lg">
            <div className="flex items-center gap-3 text-left">
              <Mail size={24} className="text-[#ff8c00] shrink-0" />
              <p className="text-sm text-gray-400">Click the link in your email to verify your account, then you can sign in.</p>
            </div>
          </div>
          <Button
