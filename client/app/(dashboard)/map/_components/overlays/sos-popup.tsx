                ...
                <div className="flex h-full flex-col overflow-y-auto">
                        ...
                        >
                            <span
                                className={cn(
                                    ...
                                    isBroadcasting ? 'animate-pulse bg-green-400' : 'bg-gray-400'
                                )}
                            />
                            <span>
                                {isBroadcasting ? 'BROADCASTING LOCATION' : 'BROADCAST ENDED'}
                            </span>
                        </div>
                    ...
                    <div className="mx-4 flex items-center justify-between rounded-t-2xl bg-orange-600 px-4 py-4">
                        ...
                        <Button
                            variant="secondary"
                            size="sm"
                            className="gap-2 rounded-full bg-[#2A2A2A] text-white hover:bg-[#3A3A3A]"
                        >
                    ...
                    <div className="mx-4 bg-[#2A2A2A] p-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-green-400">
                                Location shared with {contactsShared} contacts
                            </span>
                        </div>
                            ...
                            {safetyChecklist.map((item) => (
                                ...
                                >
                                    ...
                                    <span
                                        className={cn(
                                            'text-sm',
                                            item.checked ? 'text-gray-400' : 'text-white'
                                        )}
                                    >
                                        {item.label}
                                    </span>
                    ...
                    <div className="mx-4 mt-4 mb-8">
                        <span className="mb-4 block text-xs font-semibold tracking-wider text-gray-400">
                            EMERGENCY SERVICES
                        </span>
                        ...
                        <div className="space-y-3">
                            {emergencyServices.map((service) => (
                                <div
                                    key={service.id}
                                    className="flex items-center justify-between rounded-2xl bg-[#2A2A2A] p-4"
                                >
                                    <div className="flex items-center gap-3">
                                        <div
                                            className={cn(
