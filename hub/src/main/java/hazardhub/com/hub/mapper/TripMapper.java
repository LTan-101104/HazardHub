...
public final class TripMapper {
    ...
    public static Trip toEntity(TripDTO dto) {
        ...
        Trip.TripBuilder builder = Trip.builder()
                ...
                .status(dto.getStatus() == null ? TripStatus.PLANNING : dto.getStatus());
    ...
    public static void updateEntityFromDTO(TripDTO dto, Trip entity) {
        ...
        if (dto.getOriginLatitude() != null) {
            entity.setOriginLatitude(dto.getOriginLatitude());
        }
        if (dto.getOriginLongitude() != null) {
            entity.setOriginLongitude(dto.getOriginLongitude());
        }
